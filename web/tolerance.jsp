<%-- 
Document   : tolerance
Created on : 19 May, 2014, 12:12:50 AM
Author     : Nitin
--%>
...
<html>
    <head>
        ...
        <script language="javascript">
            ...
            {
                var p1 = document.forms["changetolerance"]["tolerance"].value;
                if (p1 == null || p1 == "" || p2 == null || p2 == "")
                {
                    alert("Tolerance fields can not be left blank");
                    return false;
                }
        ...
        <div id="main">
            ...
            <section id="top" class="one">
                <div class="container">
                    ...
                    <header>
                        <center>
                            <h2 class="alt"><strong>Edit tolerance Level</strong></h2>
                        </center>
                    </header>
                    <form name="changetolerance" action="tolerance"  method="post" onsubmit="return checkFormValidator()">
