<%-- 
Document   : showresult
Created on : 19 May, 2014, 2:26:52 AM
Author     : Nitin
--%>

<%@page import="com.sixdegrees.model.showresult"
import="com.sixdegrees.model.showfriends"
            ...
            <section id="portfolio" class="two">
                <div class="container">
                    ...
                    <center>
                        ...
                        if(name==null || name=="")
                        {%>
                        <font size="+2.0">Search Field can not be blank!</font>
                        <%}
                        else
                        {
                        ...
                        <a href="showdetails.jsp?name=<%=s1%>"><%=s1%></a>
                        <%
                        ...
                        %>
                        <a href="sendrequest?user=<%=s1%>">ADD</a>
